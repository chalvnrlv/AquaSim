...
import { nodeObject, Fn, mat3, vec2, vec3, vec4, float, int, If } from 'three/src/nodes/tsl/TSLBase.js';
...
import { PI, cos, sin, pow, clamp, abs, max, mix, sqrt, acos, dot, normalize, cross } from 'three/src/nodes/math/MathNode.js';
import { div, mul, add, sub } from 'three/src/nodes/math/OperatorNode.js';
import { Loop } from 'three/src/nodes/utils/LoopNode.js';
import { passTexture } from 'three/src/nodes/display/PassNode.js';
